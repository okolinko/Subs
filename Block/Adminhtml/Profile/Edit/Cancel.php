...
class Cancel extends \Magento\Backend\Block\Widget\Form\Container {
    ...
    protected function _construct() {
        ...
        $this->_controller  = 'adminhtml_profile_edit_cancel';
        $this->_objectId    = 'edit_subscription';
        
        $this->buttonList->update('save', 'label', __('Cancel Subscription'));
